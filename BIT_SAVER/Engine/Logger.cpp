...
CS230::Logger::Logger(Logger::Severity severity, bool useConsole, std::chrono::system_clock::time_point starttime) : minLevel(severity), outStream("Trace.log"), startTime(starttime) {
	if (useConsole == true) {
